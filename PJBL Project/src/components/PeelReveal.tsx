          ...
          <div className="peel__text">
            ...
            <div className="peel__features">
              <div className="peel__feature">
                <span className="peel__feature-icon"><i className="fa-solid fa-leaf"></i></span>
                <div>
                  <h4>Bahan Segar</h4>
              ...
              <div className="peel__feature">
                <span className="peel__feature-icon"><i className="fa-solid fa-tag"></i></span>
                <div>
              ...
              <div className="peel__feature">
                <span className="peel__feature-icon"><i className="fa-solid fa-comments"></i></span>
                <div>
                  <h4>Pesan Mudah</h4>
