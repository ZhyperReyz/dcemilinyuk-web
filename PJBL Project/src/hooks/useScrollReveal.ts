...
/** Staggered reveal on child elements with .reveal-child class */
...
/** Text lines animate from below with overflow hidden wrapper */
...
/** Parallax effect — moves element at different speed than scroll */
